      ...
      <View className="justify-between items-center flex-row w-full px-4 pb-2 border-b border-neutral-400">
        ...
        >
         ...
         <View className="w-1/3 items-end ">
          <View className="bg-neutral-400 rounded-full p-1">
            <FaceSmileIcon size={hp(3)} />
          </View>
        </View>
      </View>
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              >
                ...
                {item.sender === "me" && (
                  <Text className="text-xs font-semibold text-white text-right justify-end align-baseline ms-5">
                    {"Read "}
                    {item.timestamp}
                  </Text>
                )}
       ...
       <View className="absolute flex-row justify-between items-center w-full px-4 pb-20 pt-2 bg-white bottom-0">
        <View className="flex-row items-center rounded-2xl bg-neutral-200 px-3 py-10 w-[85%] ">
          <TextInput
            ...
            className="flex-1 text-base mb-30 pl-1 tracking-wider pb-6"
          />
