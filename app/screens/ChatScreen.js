...
import { chatData } from "../content/index";
  ...
  return (
    <SafeAreaView
      ...
      style={{paddingTop: android ? hp(3): 0}}>
        ...
        <View className="mx-4 my-6 flex-row items-center bg-neutral-200 px-3 py-4 rounded-2xl">
        <TextInput
          placeholder="Search"
        ...
        />
        <View className="">
          <MagnifyingGlassIcon size={hp(2.5)} color={"gray"} strokeWidth={3} className="flex-1 justify-end"/>
        </View>
        </View>
